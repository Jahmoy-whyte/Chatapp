    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.holdall}>
          ...
          >
            <Text style={styles.title}>Real-time chats</Text>

            <Text style={styles.subtxt}>
              Add Your Friends at a click of a button and send messages in real
              time.
            </Text>
          </MotiView>
        </View>
        ...
        <Button text={"Next"} Function={() => navigation.navigate("ready")} />
      </SafeAreaView>
    </>
  );
};
